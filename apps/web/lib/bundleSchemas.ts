...
const schemas = {
  ...
  "coin-age": z.object({
    summary: z.object({
      latestWeekStart: z.string().nullable(),
      avgCoinAgeDays: z.number(),
      includedBalance: z.number(),
      excludedBalance: z.number(),
      includedSupplyPct: z.number(),
      excludedSupplyPct: z.number(),
      includedWallets: z.number(),
      excludedWallets: z.number(),
      circulatingSupply: z.number(),
      latestSnapshotBalance: z.number(),
      latestSnapshotWallets: z.number(),
    }),
    buckets: z.array(z.object({ label: z.string() })),
    history: z.array(z.object({
      weekStart: z.string(),
      avgCoinAgeDays: z.number().nullable(),
      wallets: z.number(),
      balance: z.number(),
    })),
    bucketHistory: z.array(z.object({
      weekStart: z.string(),
      bucket: z.string(),
      avgCoinAgeDays: z.number().nullable(),
      wallets: z.number(),
    ...
    excludedWallets: z.array(z.object({
      address: z.string(),
      balance: z.number(),
      tx_in: z.number(),
      tx_out: z.number(),
